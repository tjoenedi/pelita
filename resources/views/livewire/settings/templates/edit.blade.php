<div>
    <div class="mb-6">
        <flux:heading size="xl">Edit Communication Template</flux:heading>
        <flux:text class="mt-2 text-zinc-600 dark:text-zinc-400">
            Update this email or SMS template for event reminders.
        </flux:text>
        <flux:text class="mt-1 text-sm text-zinc-500 dark:text-zinc-500">
